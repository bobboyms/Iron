...
class IronParser final : public antlr4::Parser
{
public:
    enum
    {
    ...
    {
        RuleProgram = 0,
        RuleImportStatement = 1,
        RuleQualifiedName = 2,
        RuleEntryPoint = 3,
        RuleStatementList = 4,
        RuleReturnStatement = 5,
        RuleFunctionDeclaration = 6,
        RuleArrowFunctionInline = 7,
        RuleArrowFunctionBlock = 8,
        RuleFunctionSignature = 9,
        RuleFunctionReturnType = 10,
        RuleFunctionArgs = 11,
        RuleFunctionArg = 12,
        RuleFunctionCall = 13,
        RuleFunctionCallArgs = 14,
        RuleFunctionCallArg = 15,
        RuleVarDeclaration = 16,
        RuleAssignment = 17,
        RuleVarAssignment = 18,
        RuleExpr = 19,
        RuleNumber = 20,
        RuleDataFormat = 21,
        RuleVarTypes = 22
