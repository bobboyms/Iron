...
public:
  ...
  virtual void enterLoopStatementList(IronParser::LoopStatementListContext *ctx) = 0;
  virtual void exitLoopStatementList(IronParser::LoopStatementListContext *ctx) = 0;
