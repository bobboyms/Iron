...
TEST_F(HlIrTest, HlIrTestExpr1Test)
{
    ...
    std::string output = R"(
        ...
        let c:float = 65.00F
        let e:int = 12
        let var_1:double = a float to double
        let var_2:double = PLUS var_1, b
        let var_3:float = call float value()
        let var_4:double = var_3 float to double
        let var_5:double = MULT var_2, var_4
        let var_6:int = var_5 double to int
        let result:int = var_6
        } 
    )";
